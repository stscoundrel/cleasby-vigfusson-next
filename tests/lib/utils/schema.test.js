    ...
    const expected = JSON.stringify(
      {
        ...
        '@type': 'DefinedTerm',
        '@id': 'https://cleasbyvigfusson.test/word/aedi-stormr',
        name: 'Cleasby & Vigfusson Dictionary - Æði-stormr',
        description: 'adj. a furious gale, Barl. 38, Art. 112.',
    ...
    const expected = JSON.stringify(
      [
        ...
        },
        {
          '@context': 'https://schema.org/',
          '@type': 'DefinedTerm',
          '@id': 'https://cleasbyvigfusson.test/word/aedi-straumr',
          name: 'Cleasby & Vigfusson Dictionary - Æði-straumr',
          description: 'm. a furious current, Art. 66.',
          inDefinedTermSet: 'https://cleasbyvigfusson.test',
        },
      ],
    )

...
const getDefinedTermSetData = (content) => {
  ...
  return {
    ...
    name: `Cleasby & Vigfusson Dictionary - ${letter.toUpperCase()}`,
    description: `Old Norse words starting with letter ${letter.toUpperCase()}`,
  }
}
...
const getDefinedTermData = (content) => {
  ...
  return {
    ...
    name: `Cleasby & Vigfusson Dictionary - ${capitalize(content.word)}`,
